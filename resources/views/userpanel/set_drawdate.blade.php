            ...
            <div class="row">
                <div class="container my-3 main-container">
                    <div class="row align-items-center">
                        ...
                        @if($button)
                        <div class="col-auto">
                            <button class="btn btn-rounded pink-gradient text-uppercase pr-3" data-toggle="modal" data-target="#result"><i class="material-icons">add</i> <span class="text-hide-xs">ADD NEW DRAW DATE</span></button>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header" id="createOrderTitle">
                    <div class="col text-center">
                        ...
                        <br>
                        <h5 class="mt-4 text-info">Set New Draw Date </h5>
                        <p class="text-info"></p>
                    </div>
                ...
                <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label style="color:#000;">Start Selling Date</label>
                                 <input type="date" class="form-control">
                            </div>
                            <div class="form-group">
                                  <label style="color:#000;">Draw Date</label>
                                 <input type="date" class="form-control">
                            </div>
                        </form>
                </div>
