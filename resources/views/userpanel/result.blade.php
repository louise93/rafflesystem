            ...
            <div class="row">
                <div class="container my-3 main-container">
                    <div class="row align-items-center">
                        ...
                        @if($button)
                        <div class="col-auto">
                            <button class="btn btn-rounded pink-gradient text-uppercase pr-3" data-toggle="modal" data-target="#deposit"><i class="material-icons">add</i> <span class="text-hide-xs">DEPOSIT</span></button>
                        </div>
                        @endif
                    </div>
                </div>
